...
import cssClientGlobalStylelintChange from './rules/css/clientGlobalStylelintChange';
...
import jsClientGlobalEslintChange from './rules/js/clientGlobalEslintChange';
import jsClientLockfile from './rules/js/clientLockfile';
